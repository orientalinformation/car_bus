  ...
  <div class="content_resize">
    <div class="mainbar">
      <div class="article">
          ...
          <div class="clr"></div>
      		<form action="/users/login/attempt" method="post" id="dangnhap">
            {{ csrf_field() }} 
      			...
      			<p><input class="bt" type="submit" value="Đăng Nhập"/>Nếu bạn chưa có tài khoản vui lòng click 
              <a href="/users/register">vào đây</a> để đăng kí
            </p>
